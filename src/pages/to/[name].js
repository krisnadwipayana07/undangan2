...
function Home() {
    ...
    return (
        <>
            <Head>
                <title>Wah Yuda & Ayu Cahyani - Kondangan</title>
                <meta
                    name="description"
                    content="Website dibuat oleh Kondangan"
                />
                <meta
                    name="viewport"
                ...
                <meta
                    ...
                    content="Wah Yuda & Ayu Cahyani"
                />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Wah Yuda & Ayu Cahyani" />
                <meta
                    property="og:description"
                    content="Undangan pawiwahan Wah Yuda & Ayu Cahyani"
                />
                <meta
                    property="og:image"
                    content="https://ngurahayu.vercel.app/assets/thumbnail.jpg"
                />
                    ...
                    >
                        ...
                        >
                            <Stack spacing={4}>
                                ...
                                <Text fontFamily="Philosopher">
                                    “Anvārabhethām anusam-rabhethām, Etam lokam
                                    srad-dadhānāh sacante.”
                                </Text>
                                <Text fontFamily="Philosopher">
                                    “Wahai pasangan suami-isteri, kembangkanlah
                                    cinta kasih di dalam dirimu, tekun dan
                                    tetaplah berkarma dalam menggapai
                                    kebahagiaan. Karena hanya orang yang
                                    bersungguh-sungguhlah mendapatkan
                        ...
                        >
                            ...
                            >
                                ...
                                Widhi Wasa, perkenankanlah kami mengundang
                                Bapak/Ibu/Saudara/i untuk berkenan hadir di
                                acara Manusa Yadnya Pawiwahan kami yang akan
                                dilaksanakan pada:
                            </Text>
                            <Box
                                px="5"
